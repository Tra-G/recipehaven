...
<head>
    ...
    <link rel="stylesheet" href="<?php echo assets('css/userblogmanagement.css'); ?>">
</head>
<body>
            ...
            <div class="main-item">
                ...
                <?php else: ?>
                    <?php foreach ($posts as $post): ?>
                        <li>
                            <?php echo $post['title']; ?>
                            [<a href="<?php echo route('blog/'.$post['id']); ?>" style="color: blue">View</a>
                            [<a href="<?php echo route('admin/post/'.$post['id'].'/edit'); ?>" style="color: blue">Edit</a>]
                            [<a href="<?php echo route('admin/post/'.$post['id'].'/delete'); ?>" onclick="return confirm('Are you sure you want to delete this post?');" style="color: blue">Delete</a>]
                        </li>
                    <?php endforeach; ?>
                <?php endif; ?>
                <?php if ($prev): ?>
                    <a href="<?php echo route('admin/blog', ['page' => $prev]); ?>" style="color: blue">Previous</a>
                <?php endif; ?>
                <?php if ($next): ?>
                    <a href="<?php echo route('admin/blog', ['page' => $next]); ?>" style="color: blue">Next</a>
                <?php endif; ?>
                </ul>
            </div>
        </div>

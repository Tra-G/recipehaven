                    ...
                    <div class="admin-list2">
                        <form method="post" enctype="multipart/form-data">
                            <div class="form-input">
                                ...
                                <input type="text" placeholder="Enter the title of your post" name="title" id="title" value="<?php echo $post['title']; ?>" required>
                            </div>

                            <div class="form-input">
                                <label for="content">Content</label>
                                <textarea name="content" id="content" cols="30" rows="13" required><?php echo $post['content']; ?></textarea>
                            </div>

                            <div style="margin: 1rem 0;">
                                <label style="display: block; margin-bottom: .5rem;" for="image">Image (Leave empty to use previous)</label>

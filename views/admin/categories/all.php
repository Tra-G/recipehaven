                    ...
                    <ul class="admin-list">
                        ...
                        <?php else: ?>
                            <?php foreach ($categories as $cat): ?>
                                <li>
                                    <?php echo $cat['name']; ?>
                                    [<a href="<?php echo route('admin/category/'.$cat['id'].'/edit'); ?>" style="color: blue">Edit</a>]
                                    [<a href="<?php echo route('admin/category/'.$cat['id'].'/delete'); ?>" onclick="return confirm('Are you sure you want to delete this category?');" style="color: blue">Delete</a>]
                                </li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </ul>

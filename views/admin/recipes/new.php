                    ...
                    <div class="admin-list2">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-input">
                                ...
                                <textarea name="directions" id="text" cols="30" rows="3" required></textarea>
                            </div>

                            <div class="form-input">
                                <label for="ingredients">Ingredients</label>
                                <textarea name="ingredients" id="text" cols="30" rows="2" required></textarea>
                            </div>
                            ...
                            <div style="display: flex; align-items: center;">
                                ...
                                <div class="form-input">
                                    ...
                                    <input class="serving" type="number" id="prep_time" name="prep_time" required>
                                </div>

                                <div class="form-input">
                                    <label for="servings">Servings</label>
                                    <input class="serving" type="number" id="servings" name="servings" required>
                                </div>
                            </div>

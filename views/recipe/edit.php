            ...
            <div class="submitrecipe-item">
                <form method="POST" enctype="multipart/form-data">
                    <div class="submitrecipe-form">
                        ...
                        <input type="text" placeholder="Give your recipe a title" id="title" name="title" value="<?php echo ($recipe['title']); ?>" required>
                    </div>

                    <div class="submitrecipe-form">
                        <label for="image">Image (Leave empty to use previous)</label>
                        <input type="file" id="image" name="image">
                    </div>

                    <div class="submitrecipe-form">
                        <label for="directions">Directions</label>
                        <textarea name="directions" id="text" cols="30" rows="10"
                            placeholder="Give a direction on how to prepare the recipe"><?php echo ($recipe['directions']); ?></textarea>
                    </div>

                    <div id="submitrecipe-form" class="submitrecipe-form ingredients-recipe">
                        <label for="ingredients">Ingredients</label>
                        <textarea id="text" name="ingredients" cols="30" rows="10"
                            placeholder="Write out the ingredients" required><?php echo ($recipe['ingredients']); ?></textarea>
                    </div>


                    <div class="submitrecipe-form">
                        <label for="servings">Servings</label>
                        <input type="number" placeholder="e.g 8" id="servings" name="servings" value="<?php echo ($recipe['servings']); ?>" required>
                    </div>

                    <div class="submitrecipe-form">
                        <label for="prep_time">Prep Time</label>
                        <div style="display: flex;">
                            <input style="width: 50%;" type="number" placeholder="e.g 30" id="prep_time"
                                name="prep_time"value="<?php echo ($recipe['prep_time']); ?>" required>
                            <select
                    ...
                    <div style="display: flex;" class="submitrecipe-form">
                        ...
                        <select
                            style="padding-left: 1rem; margin-left: 1rem; font-size: 1rem; outline: none; width: 100%;"
